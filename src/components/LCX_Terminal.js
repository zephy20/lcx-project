    ...
    return (
      <div className="row">
        <div className="col-md-12">
          ...
          <br />
          <p className="h5">
            The LCX Terminal is an advanced crypto assets autotrading, portfolio
            management and analytics platform with API integration of major
            exchanges.
          </p>
          <br />
                  ...
                  <Card.Body>
                    <Card.Text>
                      ...
                      >
                        ...
                        <div className="col-11">
                          <p className="h6">Real-time profit/loss statement</p>
                        </div>
                      </div>
                      <div
                        className="row"
